...
We found the SEA technique was capable of finding bugs,
both known and unknown, by implementing it in a proof of concept tool
...
We tested our tool by evaluating its performance in Linux applications ranked
...
usefulness for developers in real-world settings.

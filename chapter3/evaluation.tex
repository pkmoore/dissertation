...
\hline
        ...
        {\tt mmv}             & Correct             & {\bf Security Flaw} & {\bf Time Loss} & Correct\\
        {\tt install}         & Correct             & {\bf Security Flaw} & {\bf Time Loss} & {\bf Fill Disk} \\
        {\tt perl File::Copy} & Correct             & {\bf Security Flaw} & {\bf Time Loss} & {\bf Fill Disk} \\
        {\tt shutils}         & {\bf Corrupt}       & {\bf Security Flaw} & Correct         & Correct\\
        {\tt rust}            & Correct             & {\bf Sec. Flaw}     & {\bf Time Loss} & {\bf Fill Disk} \\
        {\tt boost::copyfile} & {\bf Corrupt}       & {\bf Sec. Flaw}     & {\bf Time Loss} & {\bf Fill Disk} \\
    \bottomrule{}
    \end{tabular}
    \caption{Applications and libraries analyzed to determine whether or nt

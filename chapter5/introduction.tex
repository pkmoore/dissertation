\chapter{Patter Observation Recognition and Transformation}
\label{chap:port}
...
modifying an application’s  interactions with its environment.  Using a technique known as SEA (Simulating Environmental Anomalies),  the study demonstrated that when an applications fail, the causal properties
